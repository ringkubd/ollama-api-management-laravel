        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            <form method="POST" action="{{ route('admin.roles.store') }}">
                ...
                <div class="mb-4">
                    ...
                    <p class="text-gray-500 text-xs mt-1">This will automatically generate a slug for the role.</p>
                    @error('name')
                                ...
                                @foreach($permissions as $key => $label)
                                    <div class="flex items-center">
                                        <input type="checkbox" name="permissions[]" value="{{ $key }}" id="permission_{{ $key }}"
                                            ...
                                            @if(old('permissions') && in_array($key, old('permissions'))) checked @endif>
